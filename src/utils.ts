...
const honeyProducedPerDayPerWorkerI = createSetting(
	'Honey produced Per Day Per Worker',
	0.0302,
	0,
	1
); // Grams
const honeyConsumedPerDayPerWorkerI = createSetting(
	'Honey Consumed Per Day Per worker',
	0.011,
	0,
	1
); // Grams
const workerMaxLifespanLowerBoundSummerI = createSetting(
	'Worker Max Lifespan In Summer Lower Bound',
	15,
	0
); // Workers during the summer live 15-38 days
const workerMaxLifespanUpperBoundSummerI = createSetting(
	'Worker Max Lifespan In Summer Upper Bound',
	38,
	0
);
const workerMaxLifespanLowerBoundWinterI = createSetting(
	'Worker Max Lifespan In Winter Lower Bound',
	150,
	0
...
const percentageOfFertilizedEggsI = createSetting(
	'The percentage of eggs that get fertilized',
	0.94,
	0,
	1
);
...
const numberOfBeesEatenPerDayI = createSetting(
	'The number of bees eater per day by predators',
	100,
	0
);
const percentChanceThatHiveIsFoundPerDayI = createSetting(
	'The chance that the hive gets found per day by a predator',
	0.001,
	0
);
const amountOfHoneyEatenIfHiveIsFoundI = createSetting(
	'The amount of honey eaten if the hive is found',
	50000,
	0
); // Grams
...
export {
	...
	droneMaxLifespanLowerBoundI,
	droneMaxLifespanUpperBoundI,
